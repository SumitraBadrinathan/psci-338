...
age <- (21+22+23+24)/4
WhyDoWeHaveRecitation <- "I dont know" #arrow assignment
print(WhyDoWeHaveRecitation)
age
WhyDoWeHaveRecitation

## can also use equal to sign
WhyDoWeHaveRecitation = "I don't know"
WhyDoWeHaveRecitation
## can also assign from left to right
...
listvar <- list2$boring #access elements and put them into new vars
